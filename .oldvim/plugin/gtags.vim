...
function! s:ExecLoad(option, long_option, pattern)
    ...
    if l:isfile == 1
        let l:cmd = '~/tools/global-6.2.9/global/global ' . l:option . ' ' . g:Gtags_Shell_Quote_Char . a:pattern . g:Gtags_Shell_Quote_Char
    else
        let l:cmd = '~/tools/global-6.2.9/global/global ' . l:option . 'e ' . g:Gtags_Shell_Quote_Char . a:pattern . g:Gtags_Shell_Quote_Char 
    endif
